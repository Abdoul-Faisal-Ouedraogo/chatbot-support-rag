...
load_dotenv() # Charger AVANT de lire os.getenv

# --- Clé API ---
#MISTRAL_API_KEY = "RPjX6NbHa4kFg5OrWTWqjbb8KwLbgSYC"
MISTRAL_API_KEY = os.getenv("MISTRAL_API_KEY").strip() # Nettoie les espaces/sauts de ligne
